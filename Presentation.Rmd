...
author: Enrique Martinez Diez, Bernat Godayol Farran, Paula Molina Polls, Sergio Esteban Echeverría, Niels Jakob Larsen
date: March 22, 2005
output:
...
```{r fig0, echo=FALSE, out.width="700x", fig.align="bottom"}
knitr::include_graphics("presentation_figures/methods.jpeg")
```

## Materials and methods

<font size = "3"> This project used the data extracted from Letten, A.D., Baumgartner, M., Pfrunder-Cardozo, K.R. et al.(2021).</font>

```{r fig1, echo=FALSE, out.width="700x", fig.align="center"}
knitr::include_graphics("presentation_figures/workflow.jpeg")
```
